      ...
      <div className="flex items-center justify-between h-full">
        ...
        <div className="flex items-center flex-[0.2] ml-8 space-x-6">
          <div className="hidden lg:flex items-center cursor-pointer space-x-2">
            <HiAdjustmentsHorizontal className="text-gray-700 size-6" />
            <p className="text-gray-700 font-semibold">Advanced</p>
          </div>
          <div className="size-12 bg-rose-600 flex items-center hover:bg-rose-800 transition-all duration-150 cursor-pointer justify-center text-white rounded-full">
            <FaSearch />
          </div>
        </div>
      </div>
